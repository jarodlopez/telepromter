...
export const objecionesData: Objecion[] = [
  ...
  },
  {
    ...
    categoria: 'precio',
    r: 'Te escucho: quieres tener la certeza de que el costo del crédito vale la pena.',
    e: 'Es completamente válido que analices cada peso; es tu dinero.',
    a: 'Seré franco contigo: no competimos por ser los más baratos, sino por lo que un banco no te da: el dinero en tu cuenta hoy, en menos de dos horas, 100% en línea y sin filas ni papeleo. Además calculamos intereses sobre saldo insoluto, así que si abonas a capital pagas menos intereses, sin penalización. ¿Calculamos juntos tu pago mensual real para que decidas con números y no con supuestos?',
    tips: [
      'Sé honesto: no eres el más barato',
      'Vende inmediatez y certeza, no precio',
      'Explica el saldo insoluto y el abono a capital',
